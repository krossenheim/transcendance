...
export const es = {
  ...
  login: {
    ...
    continueAsGuest: 'Continuar como invitado',
    continueAsGuestLoading: 'Intentando iniciar sesión como invitado...',
  ...
  friends: {
    ...
    inGame: 'En partida',
    friendsAndPrivacy: 'Amigos y Privacidad',
  ...
  pong: {
    ...
    tournament: 'Torneo',
    lastOneStanding: 'Último en Pie',
    upTo8Players: 'Hasta 8 jugadores',
    ...
    recordedOnBlockchain: 'Resultado registrado en blockchain',
    tournamentEnded: 'El torneo ha terminado',
    advancingToNextRound: '¡Avanzas a la siguiente ronda!',
    waitingForOpponent: 'Esperando a tu próximo oponente...',
    eliminatedFromTournament: 'Has sido eliminado del torneo',
    continueToNextMatch: 'Continuar al siguiente partido',
    viewTournament: 'Ver cuadro del torneo',
