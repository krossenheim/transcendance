import { PayloadToUsersSchema, UserToHubSchema, InvokeWSFunctionSchema } from "./utils/api/service/hub/hub_interfaces.js";
...
import type { TypePayloadHubToUsersSchema, T_ForwardToContainer, T_InvokeWSFunction } from "./utils/api/service/hub/hub_interfaces.js";
...
export class HubCTX {
  ...
  public disconnectUserSocket(socket: WebSocket) {
    ...
    if (wasAuthenticated) {
      ...
      const payload: GetUserType = { userId: userSocket.id! };
