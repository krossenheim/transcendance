...
const socketToHub = new WebSocket("ws://" + process.env.HUB_NAME + ":" + process.env.COMMON_PORT_ALL_DOCKER_CONTAINERS + "/inter_api");
socketToHub.on("open", () => {
...
function setSocketOnMessageHandler(socket, { tasks }) {
    socket.on("message", async (data) => {
        ...
        console.log("No matching task for URL:", clientRequest.endpoint);
...
//# sourceMappingURL=socket_to_hub.js.map