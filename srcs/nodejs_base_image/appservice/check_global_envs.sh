...
if [ -z "${HARDHAT_IPV4_ADDRESS}" ]; then echo "ERROR: HARDHAT_IPV4_ADDRESS is not set" >&2; exit 1; fi
if [ -z "${EXPLORER_IPV4_ADDRESS}" ]; then echo "ERROR: EXPLORER_IPV4_ADDRESS is not set" >&2; exit 1; fi
