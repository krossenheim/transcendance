...
CREATE TABLE IF NOT EXISTS user_dm_rooms (
  roomId INTEGER PRIMARY KEY,
  userAId INTEGER NOT NULL,
  userBId INTEGER NOT NULL,
  FOREIGN KEY(roomId) REFERENCES chat_rooms(roomId) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY(userAId) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY(userBId) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE
) STRICT;
CREATE INDEX IF NOT EXISTS idx_user_dm_rooms_userAId ON user_dm_rooms(userAId);
CREATE INDEX IF NOT EXISTS idx_user_dm_rooms_userBId ON user_dm_rooms(userBId);
