export const en = {
  ...
  pong: {
    ...
    lastOneStanding: 'Last One Standing',
    upTo8Players: 'Up to 8 players',
    ...
    recordedOnBlockchain: 'Result recorded on blockchain',
    tournamentEnded: 'The tournament has ended',
    advancingToNextRound: 'You advance to the next round!',
    waitingForOpponent: 'Waiting for your next opponent...',
    eliminatedFromTournament: 'You have been eliminated from the tournament',
    continueToNextMatch: 'Continue to Next Match',
    viewTournament: 'View Tournament Bracket',
