      ...
      {isDropdownOpen && (
        <div className={`absolute ${isRTL ? 'left-0' : 'right-0'} mt-2 w-56 glass-dark-sm glass-border shadow-dark-700 py-2 z-[10000]`}>
          <div className="px-4 py-3 border-b border-dark-700">
            ...
            <p className="text-xs text-gray-400 mt-1">{t('userMenu.userId')}: {currentUserId || "?"}</p>
          </div>
          ...
          <div className="py-1">
            <button
              ...
              className="w-full text-left px-4 py-2 text-sm text-gray-300 hover:bg-dark-700 flex items-center gap-2"
            >
